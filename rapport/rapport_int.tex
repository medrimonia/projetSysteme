...
Nous pensons aussi effectuer des tests de performance plus longs permettant de vérifier le nombre de parcours de notre liste , et la pertinence du parcours de notre liste dans certains cas.
Nous devons aussi illustrer nos différents tests déjà passés avec des graphes montrant la courbe de temps d'exécution selon la valeur en argument des fonctions, et la comparer aux performances des pthreads.
